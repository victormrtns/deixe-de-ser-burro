...
export function BookDetailPage() {
  ...
  if (bookError || writingsError) return <main className="route-error" aria-label="deixedeserburro"><h1>Não foi possível abrir este livro</h1><p>A biblioteca não respondeu. Suas escritas continuam salvas.</p><NeutralButton onClick={() => void Promise.all([retryBook(), mutate()])}>Tentar novamente</NeutralButton></main>
